...
namespace Microsoft.VisualStudio.AsyncPackageHelpers
{
    public static class ExtensionMethods
    {
        ...
        {
            Shell.Interop.IAsyncServiceProvider asyncServiceProvider = serviceProvider.GetService(typeof(Shell.Interop.SAsyncServiceProvider)) as Shell.Interop.IAsyncServiceProvider;
