...
namespace ClassLibrary
{
	partial class SolutionConfigForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxP4Client.TabIndex = 5;
			// 
			// textBoxP4User
			// 
    ...
    "ngs.";
			...
			this.radioButtonOnSave.TabIndex = 1;
			...
			this.radioButtonOnModify.TabIndex = 0;
			...
			this.checkBoxPromptForCheckout.Location = new System.Drawing.Point(25, 369);
			...
			this.checkBoxPromptForCheckout.TabIndex = 2;
