...
namespace Microsoft.VisualStudio.AsyncPackageHelpers
{
    public static class ExtensionMethods
    {
        ...
        public static async Task<T> GetServiceAsync<T>(this Shell.Interop.COMAsyncServiceProvider.IAsyncServiceProvider asyncServiceProvider, Type serviceType) where T : class
        {
            T returnValue = null;
        ...
        {
            Shell.Interop.COMAsyncServiceProvider.IAsyncServiceProvider asyncServiceProvider = serviceProvider.GetService(typeof(Shell.Interop.SAsyncServiceProvider)) as Shell.Interop.COMAsyncServiceProvider.IAsyncServiceProvider;
